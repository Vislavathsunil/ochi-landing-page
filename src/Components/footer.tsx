  ...
  return (
    <div className="w-full   md:pt-20 pb-8 px-4  md:flex gap-6 ">
      ...
      <div className="md:w-7/12 h-full  ">
        ...
        {/* Social Media Duv */}
        <div className="w-full mt-10 flex flex-col gap-4 font-['Neue_Montreal']">
          <h2>S:</h2>
          <div className="flex flex-col gap-1">
            {["Instagram", "Behance", "Facebook", "Linkedin"].map(
              (ele, index) => (
                <h2
                  key={index}
                  className="underline text-[16px] font-light cursor-pointer "
                >
                  {ele}
                </h2>
              )
          ...
          {/* address and services div */}
          <div className="w-full mt-8 flex justify-between font-['Neue_Montreal']">
          ...
          <div className="w-full h-[5vh]   mt-8 flex justify-between items-center text-zinc-500 font-['Neue_Montreal']">
            <div className=" w-1/2">
              <h2>@sunil design 2025. Legal Terms</h2>
            </div>
            <div className="w-1/2 flex justify-end">
              <h2>Website by Sunil</h2>
            </div>
          </div>
        </div>
      </div>
