...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="fixed  top-0 right-0 left-0 font-['Neue_Montreal'] z-30 ">
        {/* Desktop Navigation */}
        <div className="hidden lg:flex justify-between items-center px-6 py-6 backdrop-blur-lg">
          {/* Navbar logo  */}
          ...
          {/* Navigation links */}
          <div className="lg:flex sm:gap-10 ">
            {["Services", "Our work", "About us", "Insights", "Contact us"].map(
              (item, index) => (
                <a
                  key={index}
                  className={`text-[1.2vw] capitalize hover:cursor-pointer hover:underline hover:underline-offset-8  ${
                    index === 4 && "ml-28"
                  }`}
                >
                  {item}
        ...
        <div className="lg:hidden ">
          <div className="flex justify-between items-center  px-6 py-6 z-40">
            {/* Navbar logo  */}
            <div className="hover:cursor-pointer  ">
              <svg
                width="72"
          ...
          {navigationToggle && (
            <div className=" w-full h-screen bg-zinc-800 absolute top-0 right-0 bottom-0 text-white   transition duration-200 ease-in-out">
              <div className="flex justify-between items-center px-6 py-6">
                <h1 className="text-white text-[8vw] font-semibold">ochi</h1>
                <button onClick={handleMobile}>
              ...
              <div className="mt-8">
                <div className="border-t-[1.3px] border-zinc-500 pt-4 px-8 mb-16">
                  {[
                    "SERVICES",
                    "OURWORK",
                    "ABOUTUS",
                    ...
                    <h1 key={index} className="text-white text-[7vw] font-bold">
                      {ele}
                    </h1>
                  ))}
                </div>

                <div className="mt-8 px-8 flex flex-col gap-8  text-[4vw]">
                  {/* Social Media */}
                  ...
                  <div className="flex flex-col gap-6  ">
                    {/* Address */}
                    <div className="w-1/2 flex flex-col gap-4 text-[4vw]">
                      <h2>L:</h2>
                      <div className="flex flex-col gap-4">
                        <div>
                    ...
                    {/* Email Div */}
                    <div className="w-1/2 flex flex-col items-start justify-end gap-4">
                      <h2>E:</h2>
